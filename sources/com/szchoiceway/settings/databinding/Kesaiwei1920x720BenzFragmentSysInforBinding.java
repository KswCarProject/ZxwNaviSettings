...
public final class Kesaiwei1920x720BenzFragmentSysInforBinding implements ViewBinding {
    ...
    private Kesaiwei1920x720BenzFragmentSysInforBinding(RelativeLayout relativeLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, Button button, Button button2, RelativeLayout relativeLayout2, ScrollView scrollView, MyScrollbar myScrollbar2, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13, TextView textView14, ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ConstraintLayout constraintLayout3, ConstraintLayout constraintLayout4, ConstraintLayout constraintLayout5, ConstraintLayout constraintLayout6, RelativeLayout relativeLayout3, ConstraintLayout constraintLayout7) {
    ...
    public static Kesaiwei1920x720BenzFragmentSysInforBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720BenzFragmentSysInforBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_benz_fragment_sys_infor, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720BenzFragmentSysInforBinding bind(View view) {
        View view8 = view;
        int i = R.id.TvAppVer;
                                                                                                        ...
                                                                                                        if (constraintLayout6 != null) {
                                                                                                            ...
                                                                                                            if (relativeLayout2 != null) {
                                                                                                                ...
                                                                                                                if (constraintLayout7 != null) {
                                                                                                                    return new Kesaiwei1920x720BenzFragmentSysInforBinding((RelativeLayout) view8, textView, textView2, textView3, textView4, textView5, textView6, textView7, button, button2, relativeLayout, scrollView, myScrollbar2, textView8, textView9, textView10, textView11, textView12, textView13, textView14, constraintLayout, constraintLayout2, constraintLayout3, constraintLayout4, constraintLayout5, constraintLayout6, relativeLayout2, constraintLayout7);
                                                                                                                }
                                                                                                            }
                                                                                                        }
                                                                                                    }
