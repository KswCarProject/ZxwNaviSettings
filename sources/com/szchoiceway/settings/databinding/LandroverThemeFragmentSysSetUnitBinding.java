...
public final class LandroverThemeFragmentSysSetUnitBinding implements ViewBinding {
    ...
    public static LandroverThemeFragmentSysSetUnitBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverThemeFragmentSysSetUnitBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_theme_fragment_sys_set_unit, viewGroup, false);
        if (z) {
    ...
    public static LandroverThemeFragmentSysSetUnitBinding bind(View view) {
        View view6 = view;
