...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static boolean m82equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual((Object) bArr, (Object) ((UByteArray) obj).m93unboximpl());
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        ...
        return m92contains7apg3OU(((UByte) obj).m76unboximpl());
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static byte[] m78constructorimpl(int i) {
        return m79constructorimpl(new byte[i]);
    }

    /* renamed from: get-w2LRezQ  reason: not valid java name */
    public static final byte m84getw2LRezQ(byte[] bArr, int i) {
        return UByte.m27constructorimpl(bArr[i]);
    }

    /* renamed from: set-VurrAj0  reason: not valid java name */
    public static final void m89setVurrAj0(byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m85getSizeimpl(byte[] bArr) {
        return bArr.length;
    }
    ...
    public static java.util.Iterator<UByte> m88iteratorimpl(byte[] bArr) {
    ...
    public boolean m92contains7apg3OU(byte b) {
        return m80contains7apg3OU(this.storage, b);
    }

    /* renamed from: contains-7apg3OU  reason: not valid java name */
    public static boolean m80contains7apg3OU(byte[] bArr, byte b) {
    ...
    public static boolean m81containsAllimpl(byte[] bArr, Collection<UByte> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof UByte) || !ArraysKt.contains(bArr, ((UByte) next).m76unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
    ...
    public static boolean m87isEmptyimpl(byte[] bArr) {
