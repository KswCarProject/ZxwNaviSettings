...
public final class Kesaiwei1920x720BenzFragmentSysSetBinding implements ViewBinding {
    ...
    public final RelativeLayout viewProductLine;

    private Kesaiwei1920x720BenzFragmentSysSetBinding(RelativeLayout relativeLayout, RadioButton radioButton, RadioButton radioButton2, RadioButton radioButton3, RadioButton radioButton4, RadioButton radioButton5, RadioButton radioButton6, RadioButton radioButton7, RadioButton radioButton8, RadioButton radioButton9, RelativeLayout relativeLayout2, MyScrollbar myScrollbar2, RelativeLayout relativeLayout3, RadioGroup radioGroup2, ImageView imageView, RelativeLayout relativeLayout4, ScrollView scrollView, IndexViewPager indexViewPager, RelativeLayout relativeLayout5) {
        ...
        this.viewProductLine = relativeLayout5;
    }
    ...
    public static Kesaiwei1920x720BenzFragmentSysSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720BenzFragmentSysSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_benz_fragment_sys_set, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720BenzFragmentSysSetBinding bind(View view) {
        View view2 = view;
                                                                ...
                                                                if (relativeLayout3 != null) {
                                                                    ...
                                                                    if (scrollView != null) {
                                                                        ...
                                                                        if (indexViewPager != null) {
                                                                            ...
                                                                            RelativeLayout relativeLayout4 = (RelativeLayout) view2.findViewById(R.id.viewProductLine);
                                                                            if (relativeLayout4 != null) {
                                                                                return new Kesaiwei1920x720BenzFragmentSysSetBinding((RelativeLayout) view2, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, relativeLayout, myScrollbar2, relativeLayout2, radioGroup2, imageView, relativeLayout3, scrollView, indexViewPager, relativeLayout4);
                                                                            }
                                                                        }
                                                                    }
                                                                }
