...
public final class Kesaiwei1920x720EvoId7SetItemBinding implements ViewBinding {
    ...
    public static Kesaiwei1920x720EvoId7SetItemBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720EvoId7SetItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_evo_id7_set_item, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720EvoId7SetItemBinding bind(View view) {
                                ...
                                if (radioButton7 != null) {
                                    ...
                                    if (radioButton8 != null) {
                                        ...
                                        if (radioButton9 != null) {
                                            ...
                                            if (radioGroup != null) {
                                                return new Kesaiwei1920x720EvoId7SetItemBinding((RelativeLayout) view, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, radioGroup);
                                            }
                                        }
                                    }
                                }
