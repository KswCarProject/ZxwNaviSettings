...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            canvas.drawRGB(GyroScopeWithCompassView.CARTYPE_LISHI_LO, GyroScopeWithCompassView.CARTYPE_LISHI_LO, GyroScopeWithCompassView.CARTYPE_LISHI_LO);
            Paint paint = new Paint();
            paint.setARGB(255, GyroScopeWithCompassView.CARTYPE_DAOQI_GOMGYANG_LO, GyroScopeWithCompassView.CARTYPE_DAOQI_GOMGYANG_LO, GyroScopeWithCompassView.CARTYPE_DAOQI_GOMGYANG_LO);
