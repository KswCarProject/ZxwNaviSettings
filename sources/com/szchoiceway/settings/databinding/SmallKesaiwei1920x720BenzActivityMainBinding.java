...
public final class SmallKesaiwei1920x720BenzActivityMainBinding implements ViewBinding {
    ...
    public static SmallKesaiwei1920x720BenzActivityMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallKesaiwei1920x720BenzActivityMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_kesaiwei_1920x720_benz_activity_main, viewGroup, false);
        if (z) {
    ...
    public static SmallKesaiwei1920x720BenzActivityMainBinding bind(View view) {
                                        ...
                                        if (constraintLayout3 != null) {
                                            ...
                                            if (imageView3 != null) {
                                                ...
                                                if (indexViewPager != null) {
                                                    return new SmallKesaiwei1920x720BenzActivityMainBinding((ConstraintLayout) view, constraintLayout, imageView, clipScrollView, imageButton, imageView2, myScrollbar2, constraintLayout2, textView, constraintLayout3, imageView3, indexViewPager);
                                                }
                                            }
                                        }
                                    }
