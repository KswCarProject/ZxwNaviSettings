...
public final class AudiFragmentSysSetBackcarBinding implements ViewBinding {
    ...
    public static AudiFragmentSysSetBackcarBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysSetBackcarBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_set_backcar, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysSetBackcarBinding bind(View view) {
        View view5 = view;
