...
public final class SmallKesaiwei1920x720BenzFragmentSysSetAuxBinding implements ViewBinding {
    ...
    private SmallKesaiwei1920x720BenzFragmentSysSetAuxBinding(RelativeLayout relativeLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, CheckBox checkBox4, MyScrollView myScrollView, MyScrollbar myScrollbar2, MySeekbar1 mySeekbar1, MySeekbar1 mySeekbar12, ImageView imageView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, RelativeLayout relativeLayout6, RelativeLayout relativeLayout7, RelativeLayout relativeLayout8, RelativeLayout relativeLayout9, RelativeLayout relativeLayout10, View view, View view5) {
    ...
    public static SmallKesaiwei1920x720BenzFragmentSysSetAuxBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallKesaiwei1920x720BenzFragmentSysSetAuxBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_kesaiwei_1920x720_benz_fragment_sys_set_aux, viewGroup, false);
        if (z) {
    ...
    public static SmallKesaiwei1920x720BenzFragmentSysSetAuxBinding bind(View view) {
        View view5 = view;
                                                        ...
                                                        if (myScrollView != null) {
                                                            ...
                                                            if (myScrollbar2 != null) {
                                                                ...
                                                                if (mySeekbar1 != null) {
                                                                    ...
                                                                    if (mySeekbar12 != null) {
                                                                        i = R.id.scrollFrame;
                                                                        ImageView imageView = (ImageView) view5.findViewById(R.id.scrollFrame);
                                                                        if (imageView != null) {
                                                                            i = R.id.scrollLayout;
                                                                                                            ...
                                                                                                            if (relativeLayout9 != null) {
                                                                                                                ...
                                                                                                                if (findViewById != null) {
                                                                                                                    ...
                                                                                                                    if (findViewById2 != null) {
                                                                                                                        return new SmallKesaiwei1920x720BenzFragmentSysSetAuxBinding((RelativeLayout) view5, textView, textView2, textView3, textView4, imageButton, imageButton2, imageButton3, imageButton4, checkBox, checkBox2, checkBox3, checkBox4, myScrollView, myScrollbar2, mySeekbar1, mySeekbar12, imageView, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, relativeLayout6, relativeLayout7, relativeLayout8, relativeLayout9, findViewById, findViewById2);
                                                                                                                    }
                                                                                                                }
                                                                                                            }
                                                                                                        }
