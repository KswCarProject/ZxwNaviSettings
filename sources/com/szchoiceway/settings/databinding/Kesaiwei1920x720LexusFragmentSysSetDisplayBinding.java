...
public final class Kesaiwei1920x720LexusFragmentSysSetDisplayBinding implements ViewBinding {
    ...
    private Kesaiwei1920x720LexusFragmentSysSetDisplayBinding(RelativeLayout relativeLayout, TextView textView, ImageButton imageButton, ImageButton imageButton2, CheckBox checkBox, CheckBox checkBox2, MySeekbar1 mySeekbar1, TextView textView2, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, View view) {
    ...
    public static Kesaiwei1920x720LexusFragmentSysSetDisplayBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720LexusFragmentSysSetDisplayBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_lexus_fragment_sys_set_display, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720LexusFragmentSysSetDisplayBinding bind(View view) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (relativeLayout3 != null) {
                                                ...
                                                if (findViewById != null) {
                                                    return new Kesaiwei1920x720LexusFragmentSysSetDisplayBinding((RelativeLayout) view, textView, imageButton, imageButton2, checkBox, checkBox2, mySeekbar1, textView2, relativeLayout, relativeLayout2, relativeLayout3, findViewById);
                                                }
                                            }
                                        }
                                    }
