...
import com.szchoiceway.zxwlib.view.LandRoverBottomView;

public final class LandroverThemeActivityMainBinding implements ViewBinding {
    public final LandRoverBottomView bottomView;
    ...
    private LandroverThemeActivityMainBinding(ConstraintLayout constraintLayout, LandRoverBottomView landRoverBottomView, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, ImageButton imageButton5, ImageView imageView, ImageView imageView2, MyRecycleView myRecycleView, IndexViewPager indexViewPager) {
        this.rootView = constraintLayout;
        this.bottomView = landRoverBottomView;
    ...
    public static LandroverThemeActivityMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverThemeActivityMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_theme_activity_main, viewGroup, false);
        if (z) {
    ...
    public static LandroverThemeActivityMainBinding bind(View view) {
        int i = R.id.bottomView;
        LandRoverBottomView landRoverBottomView = (LandRoverBottomView) view.findViewById(R.id.bottomView);
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (myRecycleView != null) {
                                            ...
                                            if (indexViewPager != null) {
                                                return new LandroverThemeActivityMainBinding((ConstraintLayout) view, landRoverBottomView, imageButton, imageButton2, imageButton3, imageButton4, imageButton5, imageView, imageView2, myRecycleView, indexViewPager);
                                            }
                                        }
                                    }
                                }
