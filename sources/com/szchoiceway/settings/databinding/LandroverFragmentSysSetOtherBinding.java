...
public final class LandroverFragmentSysSetOtherBinding implements ViewBinding {
    ...
    public static LandroverFragmentSysSetOtherBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentSysSetOtherBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_sys_set_other, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentSysSetOtherBinding bind(View view) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (relativeLayout != null) {
                                            ...
                                            if (relativeLayout2 != null) {
                                                return new LandroverFragmentSysSetOtherBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, imageView, textView, relativeLayout, relativeLayout2);
                                            }
                                        }
                                    }
                                }
