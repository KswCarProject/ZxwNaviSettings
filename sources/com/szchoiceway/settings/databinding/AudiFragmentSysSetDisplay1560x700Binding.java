...
public final class AudiFragmentSysSetDisplay1560x700Binding implements ViewBinding {
    ...
    private AudiFragmentSysSetDisplay1560x700Binding(RelativeLayout relativeLayout, TextView textView, ImageButton imageButton, ImageButton imageButton2, CheckBox checkBox, CheckBox checkBox2, MySeekbar1 mySeekbar1, TextView textView2, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, View view) {
    ...
    public static AudiFragmentSysSetDisplay1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysSetDisplay1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_set_display_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysSetDisplay1560x700Binding bind(View view) {
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (findViewById != null) {
                                                return new AudiFragmentSysSetDisplay1560x700Binding((RelativeLayout) view, textView, imageButton, imageButton2, checkBox, checkBox2, mySeekbar1, textView2, relativeLayout, relativeLayout2, findViewById);
                                            }
                                        }
                                    }
                                }
