...
public final class Kesaiwei1920x720EvoId7FragmentDatatimerBinding implements ViewBinding {
    ...
    private Kesaiwei1920x720EvoId7FragmentDatatimerBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, CheckBox checkBox4) {
    ...
    public static Kesaiwei1920x720EvoId7FragmentDatatimerBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720EvoId7FragmentDatatimerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_evo_id7_fragment_datatimer, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720EvoId7FragmentDatatimerBinding bind(View view) {
                        ...
                        if (checkBox != null) {
                            ...
                            if (checkBox2 != null) {
                                ...
                                if (checkBox3 != null) {
                                    ...
                                    if (checkBox4 != null) {
                                        return new Kesaiwei1920x720EvoId7FragmentDatatimerBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, imageButton4, checkBox, checkBox2, checkBox3, checkBox4);
                                    }
                                }
                            }
                        }
