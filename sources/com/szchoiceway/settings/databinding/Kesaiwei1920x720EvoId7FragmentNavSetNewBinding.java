...
public final class Kesaiwei1920x720EvoId7FragmentNavSetNewBinding implements ViewBinding {
    ...
    private Kesaiwei1920x720EvoId7FragmentNavSetNewBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageView imageView, ImageButton imageButton2, ImageButton imageButton3, RelativeLayout relativeLayout2, TextView textView, TextView textView2, ImageView imageView2, RecyclerView recyclerView) {
    ...
    public static Kesaiwei1920x720EvoId7FragmentNavSetNewBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720EvoId7FragmentNavSetNewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_evo_id7_fragment_nav_set_new, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720EvoId7FragmentNavSetNewBinding bind(View view) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (recyclerView != null) {
                                            return new Kesaiwei1920x720EvoId7FragmentNavSetNewBinding((RelativeLayout) view, imageButton, imageView, imageButton2, imageButton3, relativeLayout, textView, textView2, imageView2, recyclerView);
                                        }
                                    }
                                }
                            }
