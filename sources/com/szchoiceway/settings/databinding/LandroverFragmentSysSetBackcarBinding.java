...
public final class LandroverFragmentSysSetBackcarBinding implements ViewBinding {
    ...
    public static LandroverFragmentSysSetBackcarBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentSysSetBackcarBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_sys_set_backcar, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentSysSetBackcarBinding bind(View view) {
        View view5 = view;
