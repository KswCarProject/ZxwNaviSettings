...
public final class Kesaiwei1920x720EvoId8FragmentStartcodeBinding implements ViewBinding {
    ...
    private Kesaiwei1920x720EvoId8FragmentStartcodeBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, ImageButton imageButton5, ImageButton imageButton6, ImageButton imageButton7, ImageButton imageButton8, ImageButton imageButton9, ImageButton imageButton10, ImageButton imageButton11, ImageButton imageButton12, TextView textView, TextView textView2) {
    ...
    public static Kesaiwei1920x720EvoId8FragmentStartcodeBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720EvoId8FragmentStartcodeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_evo_id8_fragment_startcode, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720EvoId8FragmentStartcodeBinding bind(View view) {
        View view2 = view;
        int i = R.id.BtnNum0;
                                                ...
                                                if (imageButton11 != null) {
                                                    ...
                                                    if (imageButton12 != null) {
                                                        ...
                                                        if (textView != null) {
                                                            ...
                                                            if (textView2 != null) {
                                                                return new Kesaiwei1920x720EvoId8FragmentStartcodeBinding((RelativeLayout) view2, imageButton, imageButton2, imageButton3, imageButton4, imageButton5, imageButton6, imageButton7, imageButton8, imageButton9, imageButton10, imageButton11, imageButton12, textView, textView2);
                                                            }
                                                        }
                                                    }
                                                }
