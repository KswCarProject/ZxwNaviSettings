...
public final class PempId7FragmentVolSetBinding implements ViewBinding {
    ...
    public static PempId7FragmentVolSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static PempId7FragmentVolSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.pemp_id7_fragment_vol_set, viewGroup, false);
        if (z) {
    ...
    public static PempId7FragmentVolSetBinding bind(View view) {
        View view2 = view;
                                                                                                ...
                                                                                                if (findViewById4 != null) {
                                                                                                    ...
                                                                                                    if (findViewById5 != null) {
                                                                                                        ...
                                                                                                        if (findViewById6 != null) {
                                                                                                            return new PempId7FragmentVolSetBinding((RelativeLayout) view2, button, button2, button3, button4, button5, button6, seekBar, seekBar2, seekBar3, textView, textView2, textView3, checkBox, checkBox2, checkBox3, checkBox4, checkBox5, checkBox6, scrollView, findViewById, findViewById2, findViewById3, findViewById4, findViewById5, findViewById6);
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
