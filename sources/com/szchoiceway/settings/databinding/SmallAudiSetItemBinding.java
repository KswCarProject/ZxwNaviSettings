...
public final class SmallAudiSetItemBinding implements ViewBinding {
    ...
    public static SmallAudiSetItemBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallAudiSetItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_audi_set_item, viewGroup, false);
        if (z) {
    ...
    public static SmallAudiSetItemBinding bind(View view) {
                                    ...
                                    if (radioButton8 != null) {
                                        ...
                                        if (radioButton9 != null) {
                                            ...
                                            if (radioGroup != null) {
                                                ...
                                                return new SmallAudiSetItemBinding(relativeLayout, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, radioGroup, relativeLayout);
                                            }
                                        }
                                    }
                                }
