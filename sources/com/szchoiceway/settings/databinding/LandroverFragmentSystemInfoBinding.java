...
public final class LandroverFragmentSystemInfoBinding implements ViewBinding {
    ...
    private LandroverFragmentSystemInfoBinding(RelativeLayout relativeLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, Button button, Button button2, RelativeLayout relativeLayout2) {
    ...
    public static LandroverFragmentSystemInfoBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentSystemInfoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_system_info, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentSystemInfoBinding bind(View view) {
        int i = R.id.TvAppVer;
                                        ...
                                        if (button != null) {
                                            ...
                                            if (button2 != null) {
                                                ...
                                                if (relativeLayout != null) {
                                                    return new LandroverFragmentSystemInfoBinding((RelativeLayout) view, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, button, button2, relativeLayout);
                                                }
                                            }
                                        }
                                    }
