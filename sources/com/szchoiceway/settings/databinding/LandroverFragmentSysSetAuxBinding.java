...
public final class LandroverFragmentSysSetAuxBinding implements ViewBinding {
    ...
    private LandroverFragmentSysSetAuxBinding(RelativeLayout relativeLayout, TextView textView, TextView textView2, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, CheckBox checkBox4, ImageView imageView, MyScrollView myScrollView, MySeekbar1 mySeekbar1, MySeekbar1 mySeekbar12, TextView textView3, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, RelativeLayout relativeLayout6, RelativeLayout relativeLayout7) {
    ...
    public static LandroverFragmentSysSetAuxBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentSysSetAuxBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_sys_set_aux, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentSysSetAuxBinding bind(View view) {
        View view6 = view;
                                    ...
                                    if (checkBox2 != null) {
                                        ...
                                        if (checkBox3 != null) {
                                            ...
                                            if (checkBox4 != null) {
                                                ...
                                                ImageView imageView = (ImageView) view6.findViewById(R.id.lineAuxSwitch);
                                                if (imageView != null) {
                                                    i = R.id.mScrollView;
