...
final class AdjustedTimeMark extends TimeMark {
    ...
    public TimeMark m1288plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1329plusLRDsOJo(m1287getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
