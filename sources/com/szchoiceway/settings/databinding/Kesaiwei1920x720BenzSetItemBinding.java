...
public final class Kesaiwei1920x720BenzSetItemBinding implements ViewBinding {
    ...
    public static Kesaiwei1920x720BenzSetItemBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720BenzSetItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_benz_set_item, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720BenzSetItemBinding bind(View view) {
                                    ...
                                    if (radioButton8 != null) {
                                        ...
                                        if (radioButton9 != null) {
                                            ...
                                            if (radioGroup != null) {
                                                ...
                                                return new Kesaiwei1920x720BenzSetItemBinding(relativeLayout, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, radioGroup, relativeLayout);
                                            }
                                        }
                                    }
                                }
