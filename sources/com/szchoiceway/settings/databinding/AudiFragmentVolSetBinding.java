...
public final class AudiFragmentVolSetBinding implements ViewBinding {
    ...
    public static AudiFragmentVolSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentVolSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_vol_set, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentVolSetBinding bind(View view) {
        View view2 = view;
