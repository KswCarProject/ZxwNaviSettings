...
public final class AudiSetItem1560x700Binding implements ViewBinding {
    ...
    public static AudiSetItem1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiSetItem1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_set_item_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiSetItem1560x700Binding bind(View view) {
                                    ...
                                    if (radioButton8 != null) {
                                        ...
                                        if (radioButton9 != null) {
                                            ...
                                            if (radioGroup != null) {
                                                ...
                                                return new AudiSetItem1560x700Binding(relativeLayout, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, radioGroup, relativeLayout);
                                            }
                                        }
                                    }
                                }
