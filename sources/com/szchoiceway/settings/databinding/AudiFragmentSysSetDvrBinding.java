...
public final class AudiFragmentSysSetDvrBinding implements ViewBinding {
    ...
    public static AudiFragmentSysSetDvrBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysSetDvrBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_set_dvr, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysSetDvrBinding bind(View view) {
        View view3 = view;
        int i = R.id.appList;
                                                ...
                                                if (relativeLayout2 != null) {
                                                    ...
                                                    if (relativeLayout3 != null) {
                                                        ...
                                                        if (relativeLayout4 != null) {
                                                            return new AudiFragmentSysSetDvrBinding((RelativeLayout) view3, recyclerView, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, myScrollbar2, imageView, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4);
                                                        }
                                                    }
                                                }
                                            }
