...
public final class SmallKesaiwei1920x720BenzFragmentSysSetUnitBinding implements ViewBinding {
    ...
    private SmallKesaiwei1920x720BenzFragmentSysSetUnitBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, ImageButton imageButton5, ImageButton imageButton6, ImageButton imageButton7, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, CheckBox checkBox4, CheckBox checkBox5, CheckBox checkBox6, CheckBox checkBox7, ClipScrollView clipScrollView, MyScrollbar myScrollbar2, ImageView imageView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, RelativeLayout relativeLayout6, RelativeLayout relativeLayout7, RelativeLayout relativeLayout8, RelativeLayout relativeLayout9, RelativeLayout relativeLayout10, RelativeLayout relativeLayout11, RelativeLayout relativeLayout12) {
    ...
    public static SmallKesaiwei1920x720BenzFragmentSysSetUnitBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallKesaiwei1920x720BenzFragmentSysSetUnitBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_kesaiwei_1920x720_benz_fragment_sys_set_unit, viewGroup, false);
        if (z) {
    ...
    public static SmallKesaiwei1920x720BenzFragmentSysSetUnitBinding bind(View view) {
        View view7 = view;
                                                ...
                                                if (checkBox4 != null) {
                                                    ...
                                                    if (checkBox5 != null) {
                                                        ...
                                                        if (checkBox6 != null) {
                                                            ...
                                                            if (checkBox7 != null) {
                                                                i = R.id.mScrollView;
                                                                ClipScrollView clipScrollView = (ClipScrollView) view7.findViewById(R.id.mScrollView);
                                                                if (clipScrollView != null) {
                                                                    i = R.id.myScrollbar;
                                                                    MyScrollbar myScrollbar2 = (MyScrollbar) view7.findViewById(R.id.myScrollbar);
                                                                    if (myScrollbar2 != null) {
                                                                        i = R.id.scrollFrame;
                                                                        ImageView imageView = (ImageView) view7.findViewById(R.id.scrollFrame);
                                                                        if (imageView != null) {
                                                                            i = R.id.scrollLayout;
