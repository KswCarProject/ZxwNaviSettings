...
public final class PempId7FragmentVolumeSetBinding implements ViewBinding {
    ...
    private PempId7FragmentVolumeSetBinding(RelativeLayout relativeLayout, SeekBar seekBar, SeekBar seekBar2, SeekBar seekBar3, SeekBar seekBar4, TextView textView, TextView textView2, TextView textView3, TextView textView4, View view, View view2, View view3, View view4) {
    ...
    public static PempId7FragmentVolumeSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static PempId7FragmentVolumeSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.pemp_id7_fragment_volume_set, viewGroup, false);
        if (z) {
    ...
    public static PempId7FragmentVolumeSetBinding bind(View view) {
        View view2 = view;
                                            ...
                                            if (findViewById2 != null) {
                                                ...
                                                if (findViewById3 != null) {
                                                    ...
                                                    if (findViewById4 != null) {
                                                        return new PempId7FragmentVolumeSetBinding((RelativeLayout) view2, seekBar, seekBar2, seekBar3, seekBar4, textView, textView2, textView3, textView4, findViewById, findViewById2, findViewById3, findViewById4);
                                                    }
                                                }
                                            }
                                        }
