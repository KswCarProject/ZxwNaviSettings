...
public final class AudiFragmentSysSetOther1560x700Binding implements ViewBinding {
    ...
    private AudiFragmentSysSetOther1560x700Binding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, TextView textView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3) {
    ...
    public static AudiFragmentSysSetOther1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysSetOther1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_set_other_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysSetOther1560x700Binding bind(View view) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            return new AudiFragmentSysSetOther1560x700Binding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, textView, relativeLayout, relativeLayout2);
                                        }
                                    }
                                }
                            }
