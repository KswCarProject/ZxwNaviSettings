...
public final class LandroverThemeFragmentSysSetDisplayBinding implements ViewBinding {
    ...
    private LandroverThemeFragmentSysSetDisplayBinding(RelativeLayout relativeLayout, TextView textView, ImageButton imageButton, ImageButton imageButton2, ImageView imageView, CheckBox checkBox, CheckBox checkBox2, MySeekbar1 mySeekbar1, TextView textView2, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4) {
    ...
    public static LandroverThemeFragmentSysSetDisplayBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverThemeFragmentSysSetDisplayBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_theme_fragment_sys_set_display, viewGroup, false);
        if (z) {
    ...
    public static LandroverThemeFragmentSysSetDisplayBinding bind(View view) {
                                        ...
                                        if (relativeLayout != null) {
                                            ...
                                            if (relativeLayout2 != null) {
                                                ...
                                                if (relativeLayout3 != null) {
                                                    return new LandroverThemeFragmentSysSetDisplayBinding((RelativeLayout) view, textView, imageButton, imageButton2, imageView, checkBox, checkBox2, mySeekbar1, textView2, relativeLayout, relativeLayout2, relativeLayout3);
                                                }
                                            }
                                        }
                                    }
