...
public final class AudiFragmentVolumeSet1560x700Binding implements ViewBinding {
    ...
    private AudiFragmentVolumeSet1560x700Binding(ConstraintLayout constraintLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, Button button, Button button2, MySeekbar1 mySeekbar1, MySeekbar1 mySeekbar12, MySeekbar1 mySeekbar13, MySeekbar1 mySeekbar14, RelativeLayout relativeLayout, View view, View view2, View view3, View view4, RelativeLayout relativeLayout2) {
    ...
    public static AudiFragmentVolumeSet1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentVolumeSet1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_volume_set_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentVolumeSet1560x700Binding bind(View view) {
        View view2 = view;
                                                            ...
                                                            if (findViewById3 != null) {
                                                                ...
                                                                if (findViewById4 != null) {
                                                                    ...
                                                                    if (relativeLayout2 != null) {
                                                                        return new AudiFragmentVolumeSet1560x700Binding((ConstraintLayout) view2, textView, textView2, textView3, textView4, button, button2, mySeekbar1, mySeekbar12, mySeekbar13, mySeekbar14, relativeLayout, findViewById, findViewById2, findViewById3, findViewById4, relativeLayout2);
                                                                    }
                                                                }
                                                            }
                                                        }
