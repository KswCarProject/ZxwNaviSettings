...
public final class LandroverFragmentSysSetDvrBinding implements ViewBinding {
    ...
    public static LandroverFragmentSysSetDvrBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentSysSetDvrBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_sys_set_dvr, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentSysSetDvrBinding bind(View view) {
        int i = R.id.appList;
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (relativeLayout3 != null) {
                                                ...
                                                if (relativeLayout4 != null) {
                                                    return new LandroverFragmentSysSetDvrBinding((RelativeLayout) view, recyclerView, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4);
                                                }
                                            }
                                        }
                                    }
