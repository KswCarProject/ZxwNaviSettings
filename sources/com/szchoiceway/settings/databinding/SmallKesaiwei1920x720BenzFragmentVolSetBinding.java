...
public final class SmallKesaiwei1920x720BenzFragmentVolSetBinding implements ViewBinding {
    ...
    public static SmallKesaiwei1920x720BenzFragmentVolSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallKesaiwei1920x720BenzFragmentVolSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_kesaiwei_1920x720_benz_fragment_vol_set, viewGroup, false);
        if (z) {
    ...
    public static SmallKesaiwei1920x720BenzFragmentVolSetBinding bind(View view) {
        View view9 = view;
                                                                                                                                ...
                                                                                                                                if (findViewById != null) {
                                                                                                                                    ...
                                                                                                                                    if (findViewById2 != null) {
                                                                                                                                        ...
                                                                                                                                        if (findViewById3 != null) {
                                                                                                                                            return new SmallKesaiwei1920x720BenzFragmentVolSetBinding((RelativeLayout) view9, button, button2, button3, button4, button5, button6, textView, textView2, textView3, checkBox, checkBox2, checkBox3, checkBox4, checkBox5, checkBox6, myScrollView, myScrollbar2, mySeekbar1, mySeekbar12, mySeekbar13, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, relativeLayout6, relativeLayout7, relativeLayout8, relativeLayout9, relativeLayout10, findViewById, findViewById2, findViewById3);
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
