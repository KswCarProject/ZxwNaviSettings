...
public final class Kesaiwei1920x720BenzFragmentVolumeSetBinding implements ViewBinding {
    ...
    public static Kesaiwei1920x720BenzFragmentVolumeSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720BenzFragmentVolumeSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_benz_fragment_volume_set, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720BenzFragmentVolumeSetBinding bind(View view) {
        View view4 = view;
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (myScrollView != null) {
                            i = R.id.myScrollbar;
                            MyScrollbar myScrollbar2 = (MyScrollbar) view4.findViewById(R.id.myScrollbar);
                                                                            ...
                                                                            if (findViewById2 != null) {
                                                                                ...
                                                                                if (findViewById3 != null) {
                                                                                    ...
                                                                                    if (findViewById4 != null) {
                                                                                        return new Kesaiwei1920x720BenzFragmentVolumeSetBinding((RelativeLayout) view4, textView, textView2, textView3, textView4, myScrollView, myScrollbar2, mySeekbar1, mySeekbar12, mySeekbar13, mySeekbar14, relativeLayout, textView5, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, findViewById, findViewById2, findViewById3, findViewById4);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
