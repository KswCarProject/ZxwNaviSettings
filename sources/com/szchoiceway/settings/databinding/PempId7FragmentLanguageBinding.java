...
public final class PempId7FragmentLanguageBinding implements ViewBinding {
    ...
    public static PempId7FragmentLanguageBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static PempId7FragmentLanguageBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.pemp_id7_fragment_language, viewGroup, false);
        if (z) {
    ...
    public static PempId7FragmentLanguageBinding bind(View view) {
        View view2 = view;
