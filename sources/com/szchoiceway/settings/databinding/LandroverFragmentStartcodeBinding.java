...
public final class LandroverFragmentStartcodeBinding implements ViewBinding {
    ...
    public static LandroverFragmentStartcodeBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentStartcodeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_startcode, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentStartcodeBinding bind(View view) {
        View view2 = view;
        int i = R.id.BtnNum0;
                                                ...
                                                if (imageButton11 != null) {
                                                    ...
                                                    if (imageButton12 != null) {
                                                        ...
                                                        if (textView != null) {
                                                            ...
                                                            if (textView2 != null) {
                                                                return new LandroverFragmentStartcodeBinding((ConstraintLayout) view2, imageButton, imageButton2, imageButton3, imageButton4, imageButton5, imageButton6, imageButton7, imageButton8, imageButton9, imageButton10, imageButton11, imageButton12, textView, textView2);
                                                            }
                                                        }
                                                    }
                                                }
