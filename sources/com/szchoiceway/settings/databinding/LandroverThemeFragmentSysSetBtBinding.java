...
public final class LandroverThemeFragmentSysSetBtBinding implements ViewBinding {
    ...
    public final ImageView lineBtPower;
    ...
    private LandroverThemeFragmentSysSetBtBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, ImageView imageView, TextView textView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4) {
    ...
    public static LandroverThemeFragmentSysSetBtBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverThemeFragmentSysSetBtBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_theme_fragment_sys_set_bt, viewGroup, false);
        if (z) {
    ...
    public static LandroverThemeFragmentSysSetBtBinding bind(View view) {
                ...
                if (imageButton3 != null) {
                    ...
                    if (checkBox != null) {
                        ...
                        if (checkBox2 != null) {
                            ...
                            if (checkBox3 != null) {
                                i = R.id.lineBtPower;
                                ImageView imageView = (ImageView) view.findViewById(R.id.lineBtPower);
                                if (imageView != null) {
                                    i = R.id.txtBTPower;
                                        ...
                                        if (relativeLayout != null) {
                                            ...
                                            if (relativeLayout2 != null) {
                                                ...
                                                if (relativeLayout3 != null) {
                                                    return new LandroverThemeFragmentSysSetBtBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, imageView, textView, relativeLayout, relativeLayout2, relativeLayout3);
                                                }
                                            }
                                        }
                                    }
