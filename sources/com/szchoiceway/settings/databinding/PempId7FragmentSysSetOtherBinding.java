...
public final class PempId7FragmentSysSetOtherBinding implements ViewBinding {
    ...
    private PempId7FragmentSysSetOtherBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, TextView textView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3) {
    ...
    public static PempId7FragmentSysSetOtherBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static PempId7FragmentSysSetOtherBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.pemp_id7_fragment_sys_set_other, viewGroup, false);
        if (z) {
    ...
    public static PempId7FragmentSysSetOtherBinding bind(View view) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            return new PempId7FragmentSysSetOtherBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, textView, relativeLayout, relativeLayout2);
                                        }
                                    }
                                }
                            }
