...
public final class LandroverCopilotActivityMainBinding implements ViewBinding {
    ...
    public static LandroverCopilotActivityMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverCopilotActivityMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_copilot_activity_main, viewGroup, false);
        if (z) {
    ...
    public static LandroverCopilotActivityMainBinding bind(View view) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (myRecycleView != null) {
                                            ...
                                            if (indexViewPager != null) {
                                                return new LandroverCopilotActivityMainBinding((ConstraintLayout) view, findViewById, imageButton, imageButton2, imageButton3, imageButton4, imageButton5, imageView, imageView2, myRecycleView, indexViewPager);
                                            }
                                        }
                                    }
                                }
