...
public final class AudiFragmentSysSetUnitBinding implements ViewBinding {
    ...
    private AudiFragmentSysSetUnitBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, ImageButton imageButton5, ImageButton imageButton6, ImageButton imageButton7, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, CheckBox checkBox4, CheckBox checkBox5, CheckBox checkBox6, CheckBox checkBox7, ScrollView scrollView, MyScrollbar myScrollbar2, RelativeLayout relativeLayout2, TextView textView, TextView textView2, TextView textView3, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, RelativeLayout relativeLayout6, RelativeLayout relativeLayout7, RelativeLayout relativeLayout8) {
    ...
    public static AudiFragmentSysSetUnitBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysSetUnitBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_set_unit, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysSetUnitBinding bind(View view) {
        View view6 = view;
                                                                                                    ...
                                                                                                    if (relativeLayout5 != null) {
                                                                                                        ...
                                                                                                        if (relativeLayout6 != null) {
                                                                                                            ...
                                                                                                            if (relativeLayout7 != null) {
                                                                                                                return new AudiFragmentSysSetUnitBinding((RelativeLayout) view6, imageButton, imageButton2, imageButton3, imageButton4, imageButton5, imageButton6, imageButton7, checkBox, checkBox2, checkBox3, checkBox4, checkBox5, checkBox6, checkBox7, scrollView, myScrollbar2, relativeLayout, textView, textView2, textView3, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, relativeLayout6, relativeLayout7);
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
