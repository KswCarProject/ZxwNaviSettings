...
public final class AudiFragmentTimeSetBinding implements ViewBinding {
    ...
    public static AudiFragmentTimeSetBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentTimeSetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_time_set, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentTimeSetBinding bind(View view) {
        View view2 = view;
                                            ...
                                            if (checkBox4 != null) {
                                                ...
                                                if (relativeLayout != null) {
                                                    ...
                                                    if (relativeLayout2 != null) {
                                                        return new AudiFragmentTimeSetBinding((ConstraintLayout) view2, imageButton, imageButton2, imageButton3, imageButton4, button, button2, checkBox, checkBox2, checkBox3, checkBox4, relativeLayout, relativeLayout2);
                                                    }
                                                }
                                            }
                                        }
