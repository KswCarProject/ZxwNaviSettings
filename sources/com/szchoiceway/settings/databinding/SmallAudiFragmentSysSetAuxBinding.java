...
public final class SmallAudiFragmentSysSetAuxBinding implements ViewBinding {
    ...
    private SmallAudiFragmentSysSetAuxBinding(RelativeLayout relativeLayout, TextView textView, TextView textView2, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, ImageButton imageButton4, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, CheckBox checkBox4, MyScrollView myScrollView, MySeekbar1 mySeekbar1, MySeekbar1 mySeekbar12, RelativeLayout relativeLayout2, TextView textView3, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, RelativeLayout relativeLayout6, RelativeLayout relativeLayout7, RelativeLayout relativeLayout8, View view, View view6) {
    ...
    public static SmallAudiFragmentSysSetAuxBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallAudiFragmentSysSetAuxBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_audi_fragment_sys_set_aux, viewGroup, false);
        if (z) {
    ...
    public static SmallAudiFragmentSysSetAuxBinding bind(View view) {
        View view6 = view;
                                                                                        ...
                                                                                        if (relativeLayout7 != null) {
                                                                                            ...
                                                                                            if (findViewById != null) {
                                                                                                ...
                                                                                                if (findViewById2 != null) {
                                                                                                    return new SmallAudiFragmentSysSetAuxBinding((RelativeLayout) view6, textView, textView2, imageButton, imageButton2, imageButton3, imageButton4, checkBox, checkBox2, checkBox3, checkBox4, myScrollView, mySeekbar1, mySeekbar12, relativeLayout, textView3, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, relativeLayout6, relativeLayout7, findViewById, findViewById2);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
