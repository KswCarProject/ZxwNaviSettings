    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r;
            } else if (Result.m11equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    ...
                    if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        continuation.resumeWith(Result.m9constructorimpl(invoke));
                    }
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    continuation.resumeWith(Result.m9constructorimpl(ResultKt.createFailure(th)));
                }
            } else {
