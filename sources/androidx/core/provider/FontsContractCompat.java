...
public class FontsContractCompat {
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, final androidx.core.content.res.ResourcesCompat.FontCallback r4, final android.os.Handler r5, boolean r6, int r7, final int r8) {
        ...
        L_0x0048:
            ...
            androidx.core.provider.SelfDestructiveThread r3 = sBackgroundThread     // Catch:{ InterruptedException -> 0x005a }
            java.lang.Object r3 = r3.postAndWait(r1, r7)     // Catch:{ InterruptedException -> 0x005a }
            androidx.core.provider.FontsContractCompat$TypefaceResult r3 = (androidx.core.provider.FontsContractCompat.TypefaceResult) r3     // Catch:{ InterruptedException -> 0x005a }
            android.graphics.Typeface r2 = r3.mTypeface     // Catch:{ InterruptedException -> 0x005a }
        L_0x005a:
            return r2
        L_0x005b:
        ...
        L_0x0064:
            ...
            java.lang.Object r6 = r5.get(r0)     // Catch:{ all -> 0x0091 }
            java.util.ArrayList r6 = (java.util.ArrayList) r6     // Catch:{ all -> 0x0091 }
            if (r6 == 0) goto L_0x0078
            if (r3 == 0) goto L_0x0076
            r6.add(r3)     // Catch:{ all -> 0x0091 }
        L_0x0076:
            monitor-exit(r4)     // Catch:{ all -> 0x0091 }
            return r2
        L_0x0078:
            if (r3 == 0) goto L_0x0085
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0091 }
            r6.<init>()     // Catch:{ all -> 0x0091 }
            r6.add(r3)     // Catch:{ all -> 0x0091 }
            r5.put(r0, r6)     // Catch:{ all -> 0x0091 }
        L_0x0085:
            monitor-exit(r4)     // Catch:{ all -> 0x0091 }
