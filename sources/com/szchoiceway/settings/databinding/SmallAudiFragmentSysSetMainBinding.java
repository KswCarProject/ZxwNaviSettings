...
public final class SmallAudiFragmentSysSetMainBinding implements ViewBinding {
    ...
    private SmallAudiFragmentSysSetMainBinding(RelativeLayout relativeLayout, RadioButton radioButton, RadioButton radioButton2, RadioButton radioButton3, RadioButton radioButton4, RadioButton radioButton5, RadioButton radioButton6, RadioButton radioButton7, RadioButton radioButton8, RadioButton radioButton9, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RadioGroup radioGroup2, RelativeLayout relativeLayout4, ScrollView scrollView, IndexViewPager indexViewPager) {
    ...
    public static SmallAudiFragmentSysSetMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallAudiFragmentSysSetMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_audi_fragment_sys_set_main, viewGroup, false);
        if (z) {
    ...
    public static SmallAudiFragmentSysSetMainBinding bind(View view) {
        View view2 = view;
                                                        ...
                                                        if (relativeLayout3 != null) {
                                                            ...
                                                            if (scrollView != null) {
                                                                ...
                                                                if (indexViewPager != null) {
                                                                    return new SmallAudiFragmentSysSetMainBinding((RelativeLayout) view2, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, relativeLayout, relativeLayout2, radioGroup2, relativeLayout3, scrollView, indexViewPager);
                                                                }
                                                            }
                                                        }
                                                    }
