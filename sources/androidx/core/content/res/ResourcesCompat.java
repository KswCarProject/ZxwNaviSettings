...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(android.content.Context r15, android.content.res.Resources r16, android.util.TypedValue r17, int r18, int r19, androidx.core.content.res.ResourcesCompat.FontCallback r20, android.os.Handler r21, boolean r22) {
        ...
        L_0x0033:
            return r1
        L_0x0034:
            java.lang.String r1 = r12.toLowerCase()     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            java.lang.String r2 = ".xml"
            boolean r1 = r1.endsWith(r2)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            if (r1 == 0) goto L_0x0067
            android.content.res.XmlResourceParser r1 = r0.getXml(r4)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = androidx.core.content.res.FontResourcesParserCompat.parse(r1, r0)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            if (r2 != 0) goto L_0x0055
            java.lang.String r0 = "Failed to find font-family tag"
            android.util.Log.e(r11, r0)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            if (r9 == 0) goto L_0x0054
            r9.callbackFailAsync(r14, r10)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
        L_0x0054:
            return r13
        L_0x0055:
            r1 = r15
            ...
            r7 = r21
            r8 = r22
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            return r0
        L_0x0067:
            r1 = r15
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r15, r0, r4, r12, r5)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            if (r9 == 0) goto L_0x0077
            if (r0 == 0) goto L_0x0074
            r9.callbackSuccessAsync(r0, r10)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
            goto L_0x0077
        L_0x0074:
            r9.callbackFailAsync(r14, r10)     // Catch:{ XmlPullParserException -> 0x0090, IOException -> 0x0078 }
        L_0x0077:
