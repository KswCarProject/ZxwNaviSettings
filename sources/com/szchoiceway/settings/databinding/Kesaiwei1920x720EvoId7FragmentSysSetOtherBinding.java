...
public final class Kesaiwei1920x720EvoId7FragmentSysSetOtherBinding implements ViewBinding {
    ...
    private Kesaiwei1920x720EvoId7FragmentSysSetOtherBinding(RelativeLayout relativeLayout, ImageButton imageButton, ImageButton imageButton2, ImageButton imageButton3, CheckBox checkBox, CheckBox checkBox2, CheckBox checkBox3, TextView textView) {
    ...
    public static Kesaiwei1920x720EvoId7FragmentSysSetOtherBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720EvoId7FragmentSysSetOtherBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_evo_id7_fragment_sys_set_other, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720EvoId7FragmentSysSetOtherBinding bind(View view) {
                    ...
                    if (checkBox != null) {
                        ...
                        if (checkBox2 != null) {
                            ...
                            if (checkBox3 != null) {
                                ...
                                if (textView != null) {
                                    return new Kesaiwei1920x720EvoId7FragmentSysSetOtherBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, textView);
                                }
                            }
                        }
                    }
