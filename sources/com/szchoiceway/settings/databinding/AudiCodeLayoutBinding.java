...
public final class AudiCodeLayoutBinding implements ViewBinding {
    ...
    public static AudiCodeLayoutBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiCodeLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_code_layout, viewGroup, false);
        if (z) {
    ...
    public static AudiCodeLayoutBinding bind(View view) {
        View view2 = view;
        int i = R.id.BtnNum0;
                                            ...
                                            if (imageButton10 != null) {
                                                ...
                                                if (imageButton11 != null) {
                                                    ...
                                                    if (imageButton12 != null) {
                                                        ...
                                                        if (textView != null) {
                                                            return new AudiCodeLayoutBinding((RelativeLayout) view2, imageButton, imageButton2, imageButton3, imageButton4, imageButton5, imageButton6, imageButton7, imageButton8, imageButton9, imageButton10, imageButton11, imageButton12, textView);
                                                        }
                                                    }
                                                }
                                            }
