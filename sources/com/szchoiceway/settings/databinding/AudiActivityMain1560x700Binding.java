...
public final class AudiActivityMain1560x700Binding implements ViewBinding {
    ...
    private AudiActivityMain1560x700Binding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ImageView imageView, ScrollView scrollView, MyScrollbar myScrollbar2, ConstraintLayout constraintLayout3, ConstraintLayout constraintLayout4, IndexViewPager indexViewPager) {
    ...
    public static AudiActivityMain1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiActivityMain1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_activity_main_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiActivityMain1560x700Binding bind(View view) {
                        ...
                        if (constraintLayout2 != null) {
                            ...
                            if (constraintLayout3 != null) {
                                ...
                                if (indexViewPager != null) {
                                    return new AudiActivityMain1560x700Binding((ConstraintLayout) view, constraintLayout, imageView, scrollView, myScrollbar2, constraintLayout2, constraintLayout3, indexViewPager);
                                }
                            }
                        }
                    }
