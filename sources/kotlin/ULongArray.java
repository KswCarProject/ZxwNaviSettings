...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        ...
        return m248containsVKZWuLQ(((ULong) obj).m232unboximpl());
    }
    ...
    public static boolean m237containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof ULong) || !ArraysKt.contains(jArr, ((ULong) next).m232unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
