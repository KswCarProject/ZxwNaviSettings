...
public final class AudiFragmentSysSetBt1560x700Binding implements ViewBinding {
    ...
    public static AudiFragmentSysSetBt1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysSetBt1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_set_bt_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysSetBt1560x700Binding bind(View view) {
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (relativeLayout3 != null) {
                                                return new AudiFragmentSysSetBt1560x700Binding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, textView, relativeLayout, relativeLayout2, relativeLayout3);
                                            }
                                        }
                                    }
                                }
