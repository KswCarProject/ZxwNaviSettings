...
public final class Kesaiwei1920x720LexusFragmentSysSetDvrBinding implements ViewBinding {
    ...
    public static Kesaiwei1920x720LexusFragmentSysSetDvrBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720LexusFragmentSysSetDvrBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_lexus_fragment_sys_set_dvr, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720LexusFragmentSysSetDvrBinding bind(View view) {
        int i = R.id.appList;
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (relativeLayout3 != null) {
                                                ...
                                                if (relativeLayout4 != null) {
                                                    return new Kesaiwei1920x720LexusFragmentSysSetDvrBinding((RelativeLayout) view, recyclerView, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4);
                                                }
                                            }
                                        }
                                    }
