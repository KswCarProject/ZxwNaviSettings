...
public final class AudiFragmentSysInfo1560x700Binding implements ViewBinding {
    ...
    private AudiFragmentSysInfo1560x700Binding(ConstraintLayout constraintLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, Button button, Button button2, LinearLayout linearLayout, ScrollView scrollView, MyScrollbar myScrollbar2, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13, TextView textView14) {
    ...
    public static AudiFragmentSysInfo1560x700Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static AudiFragmentSysInfo1560x700Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.audi_fragment_sys_info_1560x700, viewGroup, false);
        if (z) {
    ...
    public static AudiFragmentSysInfo1560x700Binding bind(View view) {
        View view2 = view;
        int i = R.id.TvAppVer;
                                                                    ...
                                                                    if (textView11 != null) {
                                                                        ...
                                                                        if (textView12 != null) {
                                                                            ...
                                                                            if (textView13 != null) {
                                                                                ...
                                                                                if (textView14 != null) {
                                                                                    return new AudiFragmentSysInfo1560x700Binding((ConstraintLayout) view2, textView, textView2, textView3, textView4, textView5, textView6, textView7, button, button2, linearLayout, scrollView, myScrollbar2, textView8, textView9, textView10, textView11, textView12, textView13, textView14);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
