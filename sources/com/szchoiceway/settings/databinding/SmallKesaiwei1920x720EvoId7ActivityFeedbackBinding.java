...
public final class SmallKesaiwei1920x720EvoId7ActivityFeedbackBinding implements ViewBinding {
    ...
    public static SmallKesaiwei1920x720EvoId7ActivityFeedbackBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallKesaiwei1920x720EvoId7ActivityFeedbackBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_kesaiwei_1920x720_evo_id7_activity_feedback, viewGroup, false);
        if (z) {
    ...
    public static SmallKesaiwei1920x720EvoId7ActivityFeedbackBinding bind(View view) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (relativeLayout3 != null) {
                                                ...
                                                if (relativeLayout4 != null) {
                                                    return new SmallKesaiwei1920x720EvoId7ActivityFeedbackBinding((RelativeLayout) view, checkBox, button, button2, button3, checkBox2, checkBox3, textView, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4);
                                                }
                                            }
                                        }
                                    }
