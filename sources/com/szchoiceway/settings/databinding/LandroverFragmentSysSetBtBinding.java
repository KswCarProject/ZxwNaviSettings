...
public final class LandroverFragmentSysSetBtBinding implements ViewBinding {
    ...
    public static LandroverFragmentSysSetBtBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static LandroverFragmentSysSetBtBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.landrover_fragment_sys_set_bt, viewGroup, false);
        if (z) {
    ...
    public static LandroverFragmentSysSetBtBinding bind(View view) {
                                        ...
                                        if (relativeLayout != null) {
                                            ...
                                            if (relativeLayout2 != null) {
                                                ...
                                                if (relativeLayout3 != null) {
                                                    return new LandroverFragmentSysSetBtBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, imageView, textView, relativeLayout, relativeLayout2, relativeLayout3);
                                                }
                                            }
                                        }
                                    }
