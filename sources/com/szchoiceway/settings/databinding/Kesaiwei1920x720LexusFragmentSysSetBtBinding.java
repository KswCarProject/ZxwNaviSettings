...
public final class Kesaiwei1920x720LexusFragmentSysSetBtBinding implements ViewBinding {
    ...
    public static Kesaiwei1920x720LexusFragmentSysSetBtBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static Kesaiwei1920x720LexusFragmentSysSetBtBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.kesaiwei_1920x720_lexus_fragment_sys_set_bt, viewGroup, false);
        if (z) {
    ...
    public static Kesaiwei1920x720LexusFragmentSysSetBtBinding bind(View view) {
                                    ...
                                    if (relativeLayout2 != null) {
                                        ...
                                        if (relativeLayout3 != null) {
                                            ...
                                            if (relativeLayout4 != null) {
                                                ...
                                                if (imageView != null) {
                                                    return new Kesaiwei1920x720LexusFragmentSysSetBtBinding((RelativeLayout) view, imageButton, imageButton2, imageButton3, checkBox, checkBox2, checkBox3, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, imageView);
                                                }
                                            }
                                        }
                                    }
