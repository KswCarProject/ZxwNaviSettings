...
public final class SmallKesaiwei1920x720BenzFragmentSysSetDisplayBinding implements ViewBinding {
    ...
    public static SmallKesaiwei1920x720BenzFragmentSysSetDisplayBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static SmallKesaiwei1920x720BenzFragmentSysSetDisplayBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.small_kesaiwei_1920x720_benz_fragment_sys_set_display, viewGroup, false);
        if (z) {
    ...
    public static SmallKesaiwei1920x720BenzFragmentSysSetDisplayBinding bind(View view) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            ...
                                            if (relativeLayout3 != null) {
                                                ...
                                                if (findViewById != null) {
                                                    return new SmallKesaiwei1920x720BenzFragmentSysSetDisplayBinding((RelativeLayout) view, textView, imageButton, imageButton2, checkBox, checkBox2, mySeekbar1, textView2, relativeLayout, relativeLayout2, relativeLayout3, findViewById);
                                                }
                                            }
                                        }
                                    }
