...
public final class PempId7FragmentSysSetMainBinding implements ViewBinding {
    ...
    public static PempId7FragmentSysSetMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static PempId7FragmentSysSetMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.pemp_id7_fragment_sys_set_main, viewGroup, false);
        if (z) {
    ...
    public static PempId7FragmentSysSetMainBinding bind(View view) {
        View view2 = view;
                                            ...
                                            if (radioGroup2 != null) {
                                                ...
                                                if (scrollView != null) {
                                                    ...
                                                    if (indexViewPager != null) {
                                                        return new PempId7FragmentSysSetMainBinding((RelativeLayout) view2, radioButton, radioButton2, radioButton3, radioButton4, radioButton5, radioButton6, radioButton7, radioButton8, radioButton9, radioGroup2, scrollView, indexViewPager);
                                                    }
                                                }
                                            }
                                        }
